...
public class Office extends RetType{
	...
	public String toString() {
		return "Office [officeCode=" + officeCode + ", city=" + city + ", phone=" + phone + ", addressLine1="
				...
				+ ", postalCode=" + postalCode + ", territory=" + territory + ", lastUpdated=" + lastUpdated + "]";
	} 
